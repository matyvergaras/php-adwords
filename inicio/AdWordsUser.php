...
require_once 'ApiPropertiesUtils.php';
...
class AdWordsUser extends AdsUser {
  ...
  public function __construct($authenticationIniPath = null,
    ...
    $buildIniAw = parse_ini_file('build.ini', false);
    $buildIniCommon = parse_ini_file('otro/build.ini', false);
    $this->libName = $buildIniAw['LIB_NAME'];
    $this->libVersion = $buildIniCommon['LIB_VERSION'];

    $apiProps = ApiPropertiesUtils::ParseApiPropertiesFile('api.properties');
    ...
    if ($authenticationIniPath === null) {
      $authenticationIniPath = 'auth.ini';
    }
    $authenticationIni =
